            ...
            <div className="space-y-12">
                <div className="border-b border-gray-900/10 pb-12">
                    ...
                    <div className="mt-10 flex flex-col gap-y-8">
                        <Input id="name" errors={errors} required register={register} label="Name" disabled={isLoading} />
                        <div>
                            ...
                            <div className="mt-2 flex items-center gap-x-3">
                                ...
                                <CldUploadButton options={{ maxFiles: 1 }} onUpload={handleUpload} uploadPreset="wetspgef">
